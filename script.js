    ...
    const firebaseConfig = {
        ...
        storageBucket: "certificates-nss-67fa9.appspot.com",
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showMessage(
                ...
                <a href="${certificateUrl}" class="btn" style="margin-top:10px;display:inline-block;text-decoration:none;" download>
